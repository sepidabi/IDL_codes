;+
;
; NAME: fix_match_features.pro
; purpose:	tracking all the features from all frames at once
;		=> to avoid duplicating in case of disappearing/splitting features
;
...
labels3 = features3(uniq(features3(sort(features3.label)).label)).label
n_features2 = n_elements(labels2)
n_features3 = n_elements(labels3)
